 ...
 * Default font family.
 *
 * LOCAL CHANGE (see src/sds/SOURCE.md): upstream is 'WantedSans', which this
 * site does not license or ship. Pretendard is the Korean face the academy site
 * already used, loaded as a dynamic subset in src/styles/global.css.
 */
